...
- **Components** (`src/components/`): Individual Astro components for each section (Hero, About, Projects, Experience, finance, Header, Footer)
...
- finance: array of {school, degree, dateRange, achievements}