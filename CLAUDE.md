...
- **Components** (`src/components/`): Individual Astro components for each section (Hero, About, Projects, Experience, Investments, Header, Footer)
...
- investments: array of {school, degree, dateRange, achievements}